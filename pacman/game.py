...
class Game(object):
    def __init__(self):
        ...
        self.enemies.add(Slime(544,128,0,2))
        self.enemies.add(Slime(32,224,0,2))
        self.enemies.add(Slime1(160,64,2,0))
        self.enemies.add(Slime1(448,64,-2,0))
        self.enemies.add(Slime1(640,448,2,0))
        self.enemies.add(Slime1(448,320,2,0))
        self.enemies.add(Slime1(448,64,-2,0))
        self.enemies.add(Slime1(640,448,2,0))
        self.enemies.add(Slime1(448,320,2,2))
    ...
    def run_logic(self):
        if not self.game_over:
            ...
            if len(block_hit_list) > 0:
                answer = tkinter.messagebox.askquestion("REDEMPTION", "Is it haram to fast on 1ST SYAWAL?")
                if answer == 'yes':
                    self.game_over != self.player.game_over
                else :
                     tkinter.messagebox.showerror("HAHAHAH", "LOL WRONG! game over") 
                     self.player.explosion = True
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            if self.about:
                self.display_message(screen,"the game is made by adib")
